...
public class IndividuoMichalewicz extends IndividuoBinario {

	final static int NUMVAR = 0;
	final static String ID = "Funcion Michalewicz";
	final static double[] INTERVALOS = {0, Math.PI};
	
	public IndividuoMichalewicz(double precision, int n) {
	...
	public Individuo duplicate() {
		...
		clon = new IndividuoMichalewicz(this.precision, this.numVar);
	...
	public Individuo newInstance(double precision, int n) {
		// TODO Auto-generated method stub
		return new IndividuoMichalewicz(precision, n);
	}
