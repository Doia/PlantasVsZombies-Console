...
public class MutacionDeArbol extends Mutacion {

	public final static String ID = "Mutacion De Arbol";
	public final static double  PROB_FUNC= 0.8;
	...
	public MutacionDeArbol(boolean maximizacion) {
		super(ID, PROB_FUNC, maximizacion);
	}
	
	@Override
	public Mutacion newInstance(boolean maximizacion) {
		return new MutacionDeArbol(maximizacion);
	}
