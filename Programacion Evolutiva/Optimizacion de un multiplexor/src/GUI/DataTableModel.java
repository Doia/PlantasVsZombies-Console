...
public class DataTableModel extends AbstractTableModel implements Observer {
	...
	private String[] _listColumn = {"Generación", "Mejor" ,"Máximo generacion", "Mínimo generacion", "Media", "Tamaño medio poblacion", "Presión selectiva"} ;
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch(getColumnName(columnIndex)) {
			...
			case "Tamaño medio poblacion": ret = evaluation.get(4)[rowIndex]; break;
			case "Presión selectiva": ret = evaluation.get(5)[rowIndex]; break;
		}
		return ret;
	}
