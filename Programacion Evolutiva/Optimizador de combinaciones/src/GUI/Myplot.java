...
public class Myplot extends Plot2DPanel implements Observer {
	...
	public void initPlotsLines() {
		...
		String[] plotNames = {"Maximo generacion","Minimo generacion", "Mejor Absoluto","Media", "Presión Selectiva"};
		Color[] colors = {Color.GREEN, Color.MAGENTA, Color.RED, Color.BLUE, Color.BLACK};
